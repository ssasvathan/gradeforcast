	      ...
	      switch (item.getItemId()) // switch based on selected MenuItem's ID
	      {
	         ...
	         case R.id.viewCourse:
	        	    ...
	        	    courseIntent.putExtra("studentID", Integer.toString(Login.currentStudent.getID()));
	        	 	...
	        	 	return true;
	         case R.id.scheduler:
	        	 Intent schedulerIntent = new Intent(Intent.ACTION_MAIN);
	             schedulerIntent.setComponent(new ComponentName("com.project2.meeting.activity", "com.project2.meeting.activity.SelectMeetingTimeActivity"));
	             schedulerIntent.addCategory(Intent.CATEGORY_LAUNCHER);
