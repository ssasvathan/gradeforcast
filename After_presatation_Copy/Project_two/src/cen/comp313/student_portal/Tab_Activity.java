...
public class Tab_Activity  extends  TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
            ...
            //TabSpec tab3 = tabHost.newTabSpec("Event Scheduler");
           ...
           // that will be opened when particular Tab will be selected
            ...
            //tab3.setIndicator("Event Scheduler");
            Intent schedulerIntent = new Intent("com.project2.meeting.activity.SelectMeetingTimeActivity");
            //tab3.setContent(schedulerIntent);
